...
import { ArrowLeft, Moon, Leaf, Utensils, Dog, Briefcase, Heart } from 'lucide-react';

export default function OnboardingLifestyle({ selectedLifestyles, toggleLifestyle, setActiveScreen, stepProgressBar }) {
  const lifestyleOptions = [
    { label: 'Quiet & low-key', icon: Moon },
    { label: 'Sustainability', icon: Leaf },
    { label: 'Social & communal meals', icon: Utensils },
    { label: 'Pet-friendly', icon: Dog },
    { label: 'Remote-work friendly', icon: Briefcase },
              ...
              return (
                ...
                >
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center mb-3 ${
                    isSelected ? 'bg-amber text-white' : 'bg-teal-soft text-teal'
                  }`}>
