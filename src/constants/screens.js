export const SCREENS_ORDER = [
  "landing", "how-it-works", "about", "contact", "signup", "login", "forgot-password", "reset-password", "verify-email", "learning",
  ...
  "commons-chat", "commons-settings", "admin-dashboard", "admin-users", "admin-matching", "admin-pod-review",
...
export const SCREENS_LABELS = {
  ...
  "admin-matching": "Matching Engine Control", "admin-pod-review": "Suggested Pod Review", "admin-pod-management": "Pod Management", "admin-pod-detail": "Pod Commons View (Admin)",
...
export const SHELL_MODES = {
  ...
  'admin-dashboard': 'admin', 'admin-users': 'admin', 'admin-matching': 'admin', 'admin-pod-review': 'admin',
...
export const SCREEN_URLS = {
  ...
  'admin-pod-review': 'boma.app/admin/pod-review', 'admin-pod-management': 'boma.app/admin/pods',
